...
export class Player implements GameObject {
  ...
  // Constants
  private readonly maxPower = 1.0;
  private readonly maxSpeed = 400;
  private readonly stallSpeed = 80;
  private readonly maxRollRate = 3; // ~170 degrees/second
  private readonly liftCoefficient = 0.8;
  private readonly dragCoefficient = 0.02;
