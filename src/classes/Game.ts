import { GameConfig, GameState, TerrainPoint } from '../types/game.js';
...
export class Game {
  ...
  render(): void {
    ...
    this.renderSystem.drawTerrain(this.cameraX, this.terrain, (x: number) => this.getTerrainHeightAt(x));
    ...
    this.renderSystem.drawUI(this.player, this.score, (x: number) => this.getTerrainHeightAt(x));
  }
